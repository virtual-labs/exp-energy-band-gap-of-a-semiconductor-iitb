...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 1,
        question: "Select <span style='color: #018fc3'> DC Power Supply </span>",
        ans: 'dc_power_supply',
        hint: [
    ...
    question.push({
        srno: 5,
        question: "Select <span style='color: #018fc3'> Thermometer </span>",
        ans: 'thermometer',
        hint: [
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Text('dc_power_supply', new Chemistry.Point(700, 120), canvas),
        new Chemistry.Text('voltmeter', new Chemistry.Point(1550, 170), canvas),
        new Chemistry.Text('diode', new Chemistry.Point(1650, 700), canvas),
        ...
        new Chemistry.Text('ammeter', new Chemistry.Point(150, 150), canvas),
    ];
    a1_labels.map((label) => {
        label.font = '30vw Arial';
    });
}
