...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(dc_power_supply, new Chemistry.Point(600, 200), 156, 400, canvas);
    sq.name = "dc_power_supply";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(voltmeter, new Chemistry.Point(1450, 170), 155, 423, canvas);
    sq.name = "voltmeter";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(diode, new Chemistry.Point(1650, 600), 307, 101, canvas);
    sq.name = "diode";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(heater, new Chemistry.Point(280, 600), 409, 289, canvas);
    sq.name = "heater";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(thermometer, new Chemistry.Point(1000, 600), 110, 507, canvas);
    sq.name = "thermometer";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(ammeter, new Chemistry.Point(230, 300), 166, 166, canvas);
    sq.name = "ammeter";
    scene.add(sq);
}
...
{
    question = [];
    question.push({ srno: 1, question: "Select <span style='color: #018fc3'> DC Power Supply </span>", ans: "dc_power_supply", hint: ["Has Suction and Discharge", "Has valve attached", "Triangular Base"] });
    question.push({ srno: 2, question: "Select <span style='color: #018fc3'> Voltmeter </span>", ans: "voltmeter", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 3, question: "Select <span style='color: #018fc3'> Diode </span>", ans: "diode", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 4, question: "Select <span style='color: #018fc3'> Heater </span>", ans: "heater", hint: ["U-Shape", "Mounted horizontally", "Has two pins"] });
    question.push({ srno: 5, question: "Select <span style='color: #018fc3'> Thermometer </span>", ans: "thermometer", hint: ["Rectangular box with sensor", "Display SET T", "Has two wires protruding down"] });
    question.push({ srno: 6, question: "Select <span style='color: #018fc3'> Ammeter </span>", ans: "ammeter", hint: ["Rectnagular box with sensor", "Horizontal", ""] });
}
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Text("dc_power_supply", new Chemistry.Point(800, 200), canvas),
        new Chemistry.Text("voltmeter", new Chemistry.Point(1600, 170), canvas),
        new Chemistry.Text("diode", new Chemistry.Point(1650, 750), canvas),
        new Chemistry.Text("heater", new Chemistry.Point(280, 800), canvas),
        new Chemistry.Text("thermometer", new Chemistry.Point(1100, 600), canvas),
        new Chemistry.Text("ammemter", new Chemistry.Point(220, 150), canvas)
    ];
}
